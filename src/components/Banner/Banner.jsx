...
export default function Banner() {
    return (
        <div className="relative">
            <img className="object-cover w-full  h-[630px] brightness-50" src="https://plus.unsplash.com/premium_photo-1669021454166-c68562603897?q=80&w=2005&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            ...
            <div className="absolute top-20 right-8 font-bold flex flex-col justify-center items-start">
                <h1 className="uppercase text-white text-5xl text-right ">
                    {/* 
                ...
                <h4 className="uppercase text-white text-center flex justify-end w-full mt-4">
                    <p>
                        Set Your Goal. Today!!!
                    </p>
                </h4>
