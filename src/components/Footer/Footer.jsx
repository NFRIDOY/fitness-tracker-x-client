        ...
        <div className="bg-neutral mt-3">
            <footer className="footer p-10 text-neutral-content max-w-7xl mx-auto flex justify-between">
                <aside>
                    ...
                    <p>Fitness-Tracker-X<br />Providing Best Trainers</p>
                </aside>
                <nav>
            ...
            <h1 className="footer-title text-white text-center">Copyright © 2023 - All right reserved</h1>
