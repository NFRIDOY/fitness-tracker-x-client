                ...
                <div className="navbar-start">
                    ...
                    <div className="flex items-center gap-3">
                        <Link to={'/'} className="hidden md:block">
                            ...
                            {/* <IoMdFitness /> */}
                            {/* <img src="https://cdn3.vectorstock.com/i/1000x1000/23/57/fitness-logo-design-vector-23742357.jpg" alt="" className="" /> */}
                        ...
                        <a className="normal-case text-2xl font-extrabold w-fit">
                            Fitness Tracker X
                        </a>
                    </div>
